  ...
  export const getCsvDataRows = (title,selectedFilters,attributeOptions, category, tableInfo,attributeHeading,dateRange1Start,dateRange1End,dateRange2Start,dateRange2End,cardKey) => {
    ...
    if(cardKey == 4){
        if (category === "teacher" || category === "parent") {
            ...
            emptyRow1 = { attributes: '', dateRange1TotalValue: '', dateRange1StudentValue: '', dateRange1AvgValue: '', dateRange2TotalValue: '', dateRange2StudentValue: '', dateRange2AvgValue: '' };
            ...
            emptyRow1 = { attributes: '', dateRange1TotalValue: '',  dateRange1AvgValue: '', dateRange2TotalValue: '',  dateRange2AvgValue: '' };
