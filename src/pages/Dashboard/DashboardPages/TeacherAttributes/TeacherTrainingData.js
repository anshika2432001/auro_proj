...
const endpointMapping = {
  1: '/teacher/cce-training-stats',
  2: '/teacher/training-certification-teachers-education-stats',
  3: '/teacher/nature-of-employment-stats',
  4: '/teacher/day-spent-non-teaching-stats',
  6: '/teacher/hours-teachers-spend-yearly-training-stats',
  9: '/teacher/periodicity-formative-assessments-school-stats', 
};

const tableEndPoints = {
  1: '/teacher/cce-training-table',
  2: '/teacher/training-certification-teachers-education-table',
  3: '/teacher/nature-of-employment-table',
  4: '/teacher/day-spent-non-teaching-table',
  6: '/teacher/hours-teachers-spend-yearly-training-table',
  9: '/teacher/periodicity-formative-assessments-school-table', 
}
...
//parse data for first three cards based on key values
  const parseResultData = (key,type,cardKey, result) => {
    const mappings = {
      1: { key: 'cce_training', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers',dataThreeKey: 'num_students', avgKey: 'avg_score',attributeName:'Teachers CCE Training' },
      2: { key: 'training_satisfication', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers',dataThreeKey: 'num_students', avgKey: 'avg_score',attributeName:'Satisfied By Training' },
      3: { key: 'employment_nature', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers',dataThreeKey: 'num_students', avgKey: 'avg_score',attributeName:'Nature of Employment' },
      4: { key: 'days_spend_on_non_teaching_school_activities', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers',dataThreeKey: 'num_students', avgKey: 'avg_score',attributeName:'Days' },
      6: { key: 'hours_given_in_mandatory_training', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers',dataThreeKey: 'num_students', avgKey: 'avg_score',attributeName:'Hours' },
      9: { key: 'formative_assessments_periodicity', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers',dataThreeKey: 'num_students', avgKey: 'avg_score',attributeName:'Periodicity' },
  ...
  const parseResultDataCard4 = (key,cardKey, result) => {
    const mappings = {
      1: { key: 'cce_training', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers', avgKey1: 'avg_score',avgKey2: 'avg_score',attributeName:'Teachers CCE Training' },
      2: { key: 'training_satisfication', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers', avgKey1: 'avg_score',avgKey2: 'avg_score',attributeName:'Satisfied By Training' },
      3: { key: 'employment_nature', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers', avgKey1: 'avg_score',avgKey2: 'avg_score',attributeName:'Nature of Employment' },
      4: { key: 'days_spend_on_non_teaching_school_activities', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers', avgKey1: 'avg_score',avgKey2: 'avg_score',attributeName:'Days' },
      6: { key: 'hours_given_in_mandatory_training', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers', avgKey1: 'avg_score',avgKey2: 'avg_score',attributeName:'Hours' },
      9: { key: 'formative_assessments_periodicity', dataOneKey: 'num_teachers', dataTwoKey: 'num_teachers', avgKey1: 'avg_score',avgKey2: 'avg_score',attributeName:'Periodicity' },
