...
//    --------------------------TABLES-----------------------------------------------
    ...
    public ApiResponse2<?> microScholarQuizTable(ROnePayloadDto payloadDto) {
        ...
        query.append("GROUP BY \n" +
                ...
                "    ) AS user_quiz_counts\n" +
                "    GROUP BY \n" +
                "        user_quiz_counts.state_id, user_quiz_counts.district_id, quiz_count\n" +
                ") AS subquery ON qr.quiz_range = subquery.quiz_count\n" +
                "\tHAVING\n" +
                "\tsubquery.state_id IS NOT NULL\n" +
                "ORDER BY \n" +
                "    subquery.state_id, subquery.district_id, qr.quiz_range;\n");
    ...
    public ApiResponse2<?> subjectWiseBreakdownAvgScoreTable(ROnePayloadDto payloadDto) {
        ...
        query2.append("GROUP BY sd.state_id, sd.district_id, ed.subject\n" +
                "ORDER BY sd.state_id, sd.district_id, ed.subject;\n");
...
//    ---------------------------------------TRIAL-------------------------------------------
    public ApiResponse2<?> microScholarshipQuizDataTbk(ROnePayloadDto payloadDto) {
...
//            parameters2.add(payloadDto.getChildFatherQualification());
    ...
    public ApiResponse2<?> subjectWiseBreakdownAvgScoreTbk(ROnePayloadDto payloadDto) {
